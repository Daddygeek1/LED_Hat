...
LEDMatrix<MATRIX_WIDTH, -MATRIX_HEIGHT, MATRIX_TYPE> leds;

//cLEDText ScrollingMsg;
LEDText ScrollingMsg;
...
const unsigned char TxtDemo[] = { 
          ...
          EFFECT_HSV_AH "\x00\xff\xff\xff\xff\xff" " FIRST is More Than Robots              "
                                 ...
                                 // "                 " 
             EFFECT_HSV "\x00\xff\xff" " Congrats "                       
             EFFECT_HSV "\x20\xff\xff" " FTC " 
             EFFECT_HSV "\x40\xff\xff" " STATE " 
