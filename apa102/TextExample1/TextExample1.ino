...
const unsigned char TxtDemo[] = { "              "
          ...
          EFFECT_HSV "\x00\xff\xff" "-"                       
                                 ...
                                 EFFECT_HSV "\x40\xff\xff" "T" 
                                 EFFECT_HSV "\x60\xff\xff" "E" 
                                 EFFECT_HSV "\x40\xff\xff" "V"
                                 EFFECT_HSV "\x20\xff\xff" "E" 
                                 EFFECT_DELAY_FRAMES "\x00\x80"
                                 EFFECT_HSV "\x00\xff\xff" "-"                                 
                                 
          "   "                        
          EFFECT_HSV "\xa0\xff\xff" " Get excited and build a robot " 
          "   "
          ...
          "   "
          EFFECT_SCROLL_UP EFFECT_HSV "\x60\xff\xff" "STEVE" EFFECT_DELAY_FRAMES "\x00\x80"
          "   "
          EFFECT_SCROLL_LEFT EFFECT_RGB "\xcf\xff\xff"  " Wear your safety glasses "
          "   "
          EFFECT_HSV "\x60\xff\xff" " NEVER" EFFECT_DELAY_FRAMES "\x00\x80" EFFECT_HSV "\x00\xff\xff" " NEVER" EFFECT_DELAY_FRAMES "\x00\x80" EFFECT_HSV "\x40\xff\xff" " NEVER" EFFECT_DELAY_FRAMES "\x00\x80" EFFECT_HSV_CV "\x00\xff\xff\x40\xff\xff" "  GIVE UP"
          "   "
          ...
          "   "
          EFFECT_HSV_CH "\x00\xff\xff\x40\xff\xff" " The hardest fun you’ll ever have "
          "   "
          EFFECT_HSV "\x60\xff\xff" " Never Fear STEVE is here "
          "   "
          EFFECT_HSV_AV "\x00\xff\xff\x80\xff\xff" " Gracious Professionalism "
          "   "
          EFFECT_HSV "\x60\xff\xff" " FIRST is More Than Robots "
